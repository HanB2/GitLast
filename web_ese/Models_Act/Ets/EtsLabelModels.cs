...
{
    public class EtsLabelModels : SeachModel
	{
		
		public PagingModel Paging { get; set; }  //페이징
		public List<ETS_LABEL_ITEM> Items { get; set; }  // //리스트 	
		...
		public EtsLabelModels()
		{
			this.Paging = new PagingModel();
			this.Items = new List<ETS_LABEL_ITEM>();
