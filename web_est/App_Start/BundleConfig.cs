...
namespace web_est
{
    public static class BundleConfig
    {
        ...
        {
            //bundles.Add(new StyleBundle("~/content/web_est").IncludeDirectory("~/content/css", "*.min.css"));

            bundles.Add(new StyleBundle("~/content/web_est").Include(
...
//"~/content/css/demo.min.css",
            ...
            bundles.Add(new ScriptBundle("~/scripts/web_est").Include(
